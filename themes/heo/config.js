const CONFIG = {
  ...
  HEO_SITE_CREATE_TIME: '2024-02-5', // 建站日期，用于计算网站运行的第几天

  // 首页顶部通知条滚动内容，如不需要可以留空 []
  HEO_NOTICE_BAR: [
    { title: '新年到，祝大家龙年大吉！', url: '#' },
    { title: '欢迎来到我们的博客', url: '#' },
    { title: '一个属于任何人的网站', url: '#' },
    { title: '可编写任何资讯文章发布', url: '#' },
    { title: '任何人都可以向站长申请发布权限', url: '#' },
    { title: '禁止发布违法文章，发现取消权限', url: '#' }
  ],
  ...
  HEO_HERO_TITLE_5: '一个属于任何人的博客',
  HEO_HERO_TITLE_LINK: 'https://z-world.org.edu.kg',
